...
/**
 * AdminLayout — sidebar + top bar admin shell.
 */
export default function AdminLayout() {
    ...
    <>
      ...
      <div className="px-4 py-5 border-b border-gray-200">
        <NavLink to="/admin" className="flex items-center gap-2.5" onClick={() => setSidebarOpen(false)}>
          ...
          <span className="text-lg font-bold text-gray-900">ShopAI Admin</span>
        </NavLink>
      </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-gray-200 flex flex-col transform transition-transform duration-300 lg:translate-x-0 lg:static lg:z-auto ${
